...
public class GS_WidowPension extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_s__widow_pension);
        ...
        pd = new ProgressDialog(GS_WidowPension.this);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebViewClient(new GS_WidowPension.MyWebViewClient());

            mWebView.setLayerType(View.LAYER_TYPE_HARDWARE, null);

            mWebView.loadUrl("https://sspy-up.gov.in/oap/public_new/UserRegistrationForm.aspx?Scheme=WidowPension");
        }
            ...
            WebSettings webSettings = mWebView.getSettings();
            webSettings.setJavaScriptEnabled(true);
            mWebView.setWebViewClient(new GS_WidowPension.MyWebViewClient()); mWebView.setLayerType(View.LAYER_TYPE_HARDWARE, null);
