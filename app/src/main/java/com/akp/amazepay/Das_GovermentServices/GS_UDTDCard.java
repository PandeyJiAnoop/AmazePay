...
public class GS_UDTDCard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(GS_UDTDCard.this);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebViewClient(new GS_UDTDCard.MyWebViewClient());
            ...
            WebSettings webSettings = mWebView.getSettings();
            webSettings.setJavaScriptEnabled(true);
            mWebView.setWebViewClient(new GS_UDTDCard.MyWebViewClient()); mWebView.setLayerType(View.LAYER_TYPE_HARDWARE, null);
