package com.akp.amazepay.Das_GovermentServices;
...
public class GS_VridhaPension extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_s__vridha_pension);
        ...
        pd = new ProgressDialog(GS_VridhaPension.this);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebViewClient(new GS_VridhaPension.MyWebViewClient());

            mWebView.setLayerType(View.LAYER_TYPE_HARDWARE, null);

            mWebView.loadUrl("https://sspy-up.gov.in/oap/public_new/UserRegistrationForm.aspx?Scheme=OldAgePension");
        }
            ...
            WebSettings webSettings = mWebView.getSettings();
            webSettings.setJavaScriptEnabled(true);
            mWebView.setWebViewClient(new GS_VridhaPension.MyWebViewClient()); mWebView.setLayerType(View.LAYER_TYPE_HARDWARE, null);
