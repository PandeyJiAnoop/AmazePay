...
public class GS_ViklankPension extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(GS_ViklankPension.this);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebViewClient(new GS_ViklankPension.MyWebViewClient());

            mWebView.setLayerType(View.LAYER_TYPE_HARDWARE, null);

            mWebView.loadUrl("https://sspy-up.gov.in/oap/public_new/UserRegistrationForm.aspx?Scheme=HandicapPension");
        }
            ...
            WebSettings webSettings = mWebView.getSettings();
            webSettings.setJavaScriptEnabled(true);
            mWebView.setWebViewClient(new GS_ViklankPension.MyWebViewClient()); mWebView.setLayerType(View.LAYER_TYPE_HARDWARE, null);
