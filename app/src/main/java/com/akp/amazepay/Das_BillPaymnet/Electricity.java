        ...
        new ConnectToRetrofit(new RetrofitCallBackListenar() {
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(Electricity.this, 3);
                    CategoryServiceListAdapter customerListAdapter = new CategoryServiceListAdapter(Electricity.this, arrayList1);
