        ...
        new ConnectToRetrofit(new RetrofitCallBackListenar() {
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(Mobile.this, 3);
                    CategoryServiceListAdapter customerListAdapter = new CategoryServiceListAdapter(Mobile.this, arrayList1);
