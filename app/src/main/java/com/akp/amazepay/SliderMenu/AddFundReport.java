...
import com.akp.amazepay.Utility;
...
//        Toast.makeText(getApplicationContext(),""+bm,Toast.LENGTH_LONG).show();
    ...
    public void ProceedToaddFundAPI() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://amazepay.net/api/Amazepay/FundRequest", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("FundRequest",response);
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Toast.makeText(AddFundReport.this, jsonObject.getString("Msg"), Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(AddFundReport.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog1.dismiss();
//                Toast.makeText(AddFundReport.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.d("FundRequest", String.valueOf(params));
                return params;
            }
        };
...
//                        Toast.makeText(AddFundReport.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
