...
public class AO_kotakBank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_o_kotak_bank);
        ...
        pd = new ProgressDialog(AO_kotakBank.this);
        pd.setMessage("Please Wait Kotak Bank Account Form Loading...");
        pd.show();
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.loadUrl("https://kapps.kotak.com/kotakXpress/xpress/xpress-home.action?pid=PROEVDDC");
        }
